  ...
  const CHANNELS = [
    {
      name: 'LinkedIn',
      color: '#0077b5',
      handle: 'wavzfordigitaltransformation',
      url: 'https://www.linkedin.com/company/wavzfordigitaltransformation/',
      desc: ar ? 'تابعنا على لينكد إن لآخر الأخبار والفرص المهنية.' : 'Follow us for the latest news, insights, and career opportunities.',
      icon: (
    ...
    },
    {
      ...
      color: '#1877f2',
      handle: 'WAVZfordigitaltransformation',
      url: 'https://www.facebook.com/WAVZfordigitaltransformation',
      desc: ar ? 'تواصل معنا عبر فيسبوك للأخبار والتحديثات.' : 'Connect with us on Facebook for news and updates.',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 24, height: 24 }}>
    ...
    },
    {
      ...
      color: '#E1306C',
      handle: '@wavzfordigitaltransformation',
      url: 'https://www.instagram.com/wavzfordigitaltransformation/',
      desc: ar ? 'تابعنا على إنستغرام لأحدث صورنا وأنشطتنا.' : 'Follow us on Instagram for the latest visuals and activities.',
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 24, height: 24 }}>
    ...
    <div style={{ background: '#F8FAFC', minHeight: '100vh' }} dir={dir}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20 }}>
          {CHANNELS.map((ch, i) => (
            ...
            >
              <div style={{ width: 48, height: 48, borderRadius: 14, background: ch.color, display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 16, color: '#fff' }}>{ch.icon}</div>
