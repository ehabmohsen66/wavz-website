...
export const About = () => {
  ...
  // Warp shader configs — one per pillar
  const warpConfigs = [
    { proportion: 0.3, softness: 0.8, distortion: 0.15, swirl: 0.6, swirlIterations: 8,  shape: 'checks', shapeScale: 0.08, colors: ['hsl(210,100%,15%)', 'hsl(210,100%,40%)', 'hsl(195,90%,30%)', 'hsl(215,100%,60%)'] },
    { proportion: 0.4, softness: 1.2, distortion: 0.2,  swirl: 0.9, swirlIterations: 12, shape: 'dots',   shapeScale: 0.12, colors: ['hsl(200,100%,12%)', 'hsl(185,100%,35%)', 'hsl(160,90%,25%)', 'hsl(190,100%,55%)'] },
    { proportion: 0.35,softness: 0.9, distortion: 0.18, swirl: 0.7, swirlIterations: 10, shape: 'checks', shapeScale: 0.10, colors: ['hsl(220,100%,14%)', 'hsl(240,100%,45%)', 'hsl(260,90%,30%)', 'hsl(230,100%,65%)'] },
    { proportion: 0.45,softness: 1.1, distortion: 0.22, swirl: 0.8, swirlIterations: 15, shape: 'dots',   shapeScale: 0.09, colors: ['hsl(30, 100%,20%)', 'hsl(40, 100%,50%)', 'hsl(210,90%,25%)', 'hsl(35, 100%,65%)'] },
    { proportion: 0.38,softness: 0.95,distortion: 0.16, swirl: 0.85,swirlIterations: 11, shape: 'checks', shapeScale: 0.11, colors: ['hsl(195,100%,12%)', 'hsl(200,100%,38%)', 'hsl(210,90%,28%)', 'hsl(205,100%,58%)'] },
    { proportion: 0.42,softness: 1.0, distortion: 0.19, swirl: 0.75,swirlIterations: 9,  shape: 'dots',   shapeScale: 0.13, colors: ['hsl(215,100%,10%)', 'hsl(220,100%,35%)', 'hsl(40, 90%,30%)',  'hsl(218,100%,55%)'] },
  ];

  // Map core values to Lucide icons
  const valueIcons = {
    'Candor': <MessageSquare className="w-5 h-5 text-[#1173BD]" />,
    'الصراحة والشفافية': <MessageSquare className="w-5 h-5 text-[#1173BD]" />,
    'Integrity': <Lock className="w-5 h-5 text-emerald-600" />,
    'النزاهة والأمانة': <Lock className="w-5 h-5 text-emerald-600" />,
    'Respect': <Heart className="w-5 h-5 text-rose-500" />,
    'الاحترام المتبادل': <Heart className="w-5 h-5 text-rose-500" />,
    'Customer Focus': <Target className="w-5 h-5 text-[#FFB814]" />,
    'التركيز على العميل': <Target className="w-5 h-5 text-[#FFB814]" />,
    'Sense of Ownership': <Key className="w-5 h-5 text-purple-600" />,
    'روح المسؤولية والملكية': <Key className="w-5 h-5 text-purple-600" />,
    'One Team, One Goal': <Users className="w-5 h-5 text-indigo-600" />,
    'فريق واحد، هدف واحد': <Users className="w-5 h-5 text-indigo-600" />
  };
    ...
    <div className="relative overflow-hidden w-full" dir={dir}>
      ...
      <section className="relative overflow-hidden mb-20 lg:mb-28">
        ...
        <svg className="absolute inset-0 w-0 h-0 pointer-events-none">
          <defs>
            <filter id="about-glass" x="-50%" y="-50%" width="200%" height="200%">
            ...
            <filter id="about-text-glow" x="-50%" y="-50%" width="200%" height="200%">
        ...
        <div className="relative z-20 max-w-[1400px] mx-auto px-6 lg:px-12 py-20 lg:py-28">
          ...
          <div className="mb-10">
            <a
              href="#/"
              className="inline-flex items-center gap-1.5 text-white/60 hover:text-white text-[13.5px] font-semibold transition-colors duration-200"
            >
          ...
          <div className="max-w-4xl">
            <motion.div
              className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-white/20 bg-white/5 text-white/90 text-[11.5px] font-bold tracking-[0.16em] mb-6 backdrop-blur-sm"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.2 }}
            >
              <Sparkles className="w-3.5 h-3.5 text-[#FFB814]" />
              {lang === 'ar' ? 'من نحن' : 'WHO WE ARE'}
            </motion.div>

            <motion.h1
              className="text-4xl lg:text-7xl font-extrabold tracking-[-0.03em] leading-[1.05] mb-8"
            ...
            <motion.p
              className="text-[19px] lg:text-[22px] font-medium text-white/80 leading-relaxed mb-8 border-s-4 border-[#FFB814] ps-5 py-1"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div
                className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md hover:border-[#1173BD]/50 transition-all duration-300"
                style={{ filter: 'url(#about-glass)' }}
              >
                <div className="w-10 h-10 rounded-lg bg-[#1173BD]/30 flex items-center justify-center mb-4">
              ...
              <div
                className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md hover:border-[#FFB814]/50 transition-all duration-300"
                style={{ filter: 'url(#about-glass)' }}
              >
                <div className="w-10 h-10 rounded-lg bg-[#FFB814]/20 flex items-center justify-center mb-4">
                  <Compass className="w-5 h-5 text-[#FFB814]" />
                </div>
                <p className="text-[15px] text-white/75 leading-relaxed">
                  {data.introLine2}
                </p>
      ...
      {/* Remaining sections — original white background */}
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
        ...
        <section className="mb-24 lg:mb-32">
          <div className="mb-14">
            ...
            <p className="mt-3 text-[15.5px] text-slate-500 max-w-xl">
              {data.strategySubtitle}
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {data.strategyPillars.map((pillar, i) => {
              const warp = warpConfigs[i % warpConfigs.length];
              return (
                <div key={i} className="relative h-72">
                  ...
                  {/* Glass content layer */}
                  <div className="relative z-10 p-7 rounded-2xl h-full flex flex-col bg-[#061E31]/85 border border-white/10 backdrop-blur-sm hover:border-white/25 transition-all duration-300">
                    <div className="w-11 h-11 rounded-xl bg-white/10 flex items-center justify-center mb-5">
                      {strategyIcons[i % strategyIcons.length]}
                    </div>
                    <h3 className="text-[17px] font-bold text-white mb-3">
                      {pillar.title}
                    </h3>
                    <p className="text-[13.5px] text-white/65 leading-relaxed flex-1">
                      {pillar.desc}
                    </p>
        ...
        {/* ── Section 3: Chronicles & Our Story Timeline ── */}
        <section className="mb-24 lg:mb-32">
          ...
          <div className="relative border-s border-slate-200/80 ms-4 md:ms-8 space-y-12 py-4">
            {data.storyMilestones.map((milestone, idx) => (
              <div key={idx} className="relative ps-6 md:ps-10">
                {/* Timeline node dot */}
                <div 
                  className={`absolute -start-[9px] top-1.5 w-4.5 h-4.5 rounded-full border-4 border-white shadow-sm transition-all duration-300 ${
                    idx === data.storyMilestones.length - 1 ? 'bg-[#FFB814] animate-pulse' : 'bg-[#1173BD]'
                  }`}
                />
                
                <div className="flex flex-col md:flex-row md:items-start gap-4 md:gap-10">
                  {/* Luxury Year Indicator */}
                  <div className="flex-shrink-0">
                    <span className="inline-block text-[28px] font-black tracking-tight text-[#082D4A] bg-[#1173BD]/10 px-3 py-1 rounded-lg">
                      {milestone.year}
                    </span>
                  </div>

                  {/* Card content */}
                  <div className="bg-white border border-slate-200/60 rounded-2xl p-6 lg:p-7 shadow-sm flex-1 hover:shadow-md transition-all duration-200">
                    <h3 className="text-[17.5px] font-extrabold text-[#082D4A] mb-3">
                      {milestone.title}
                    </h3>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            {data.values.map((val, idx) => (
              <div 
                key={idx}
                className="bg-white border border-slate-200/80 rounded-2xl p-6 shadow-sm hover:border-[#1173BD]/30 hover:shadow-md transition-all duration-200"
              >
                <div className="flex items-center gap-3.5 mb-4">
                  <div className="w-10 h-10 rounded-lg bg-slate-50 flex items-center justify-center">
                    {valueIcons[val.name] || <Sparkles className="w-5 h-5 text-indigo-500" />}
                  </div>
                  <h3 className="text-[15.5px] font-bold text-[#082D4A]">
                    {val.name}
                  </h3>
                </div>
