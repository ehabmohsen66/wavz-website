...
try {
    ...
    // 3b. Ensure blog_categories table exists and is seeded with Arabic names
    $db->exec("
    ...
    out("[OK] Blog categories table verified and seeded with 9 standard categories.", "success");
